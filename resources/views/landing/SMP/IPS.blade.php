...
<head>
    ...
    <title>Kuis SMP IPS</title>
    <link rel="stylesheet" href="{{ asset('assets/css/SMP.css') }}">
</head>
<body>
    <body>
        <div class="quiz-container">
            <!-- Judul Pertanyaan -->
            <h1 id="quiz-ips-title">Selamat Datang di Kuis SMP IPS</h1>
    ...
    let timerInterval;
    const questions = @json($quizsmpips);
    ...
    backButton.addEventListener('click', function () {
        window.location.href = "/Smp"; // Redirect ke halaman pilih kuis
    });
