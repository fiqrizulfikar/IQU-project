...
<head>
  ...
  <style>
    /* Updated CSS for square image cropping */
* {
...
.card-container {
  ...
  padding: 15px;
  text-align: center;
  background-color:rgb(21, 33, 141);
  border-radius: 8px;
  box-shadow: 0 4px 6px rgba(93, 63, 228, 0.84);
}
...
.team-member-image {
  ...
  max-height: 600px;
  object-fit: cover;
  aspect-ratio: 5 / 6; /* Enforce 500x600 proportion */
  margin-bottom: 20px;
  border-radius: 8px;
}
